...
if(isset($_SESSION['taikhoan']))
{
	...
	while($cot = $DB->fetch_array($query))
	{
		...
		$itemKH .='
		<tr>
		<td style="width:214px"><img src="../images/khachhang/'.$cot['anh'].'" width="213" height="320" alt=""></td>
		<td style="word-break: break-all;">
			<div>
				...
				<p>- <strong>Khách hàng</strong><select id="selectThanhVien" onchange="ChangeLoaiThanhVien()"> '.$itemSelect.'</select></p>
				<br/>
