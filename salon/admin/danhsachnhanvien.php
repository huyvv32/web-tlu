		...
		<div id="page-wrapper">
			...
			<div class="tables">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input type="text" id="txtTimKiemNV" class="form-control1" placeholder="Tìm kiếm nhân viên">
												<span class="input-group-addon">
													<a href="#" onclick="timKiemNhanVien()" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> </a>
												</span>
											</div>
										</div>
									</div>
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4><a href="themnhanvien.php" class="btn btn-primary">Thêm nhân viên</a> | <a href="themloainhanvien.php" class="btn btn-primary">Thêm Loại nhân viên</a> </h4>
						<div id="dsnv">
